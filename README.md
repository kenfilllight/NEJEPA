![jepa emoji2](jepa-emoji1.png)**#NEJEPA: JEPA-Based Multimodal World Model for Real-Time Intention Recognition in Human-Robot Collaboration Neural Embodied Joint-Embedding Predictive Architecture with Violation-of-Expectation Intent Detection**
